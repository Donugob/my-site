...
const FooterLink = ({ href, children }: FooterLinkProps) => (
  <li>
    <a
      href={href}
      className="text-gray-600 hover:text-gray-900 transition-colors duration-200 inline-block relative group"
    >
      {children}
...
const SocialIcon = ({ href, children, label }: SocialIconProps) => (
  <a
    ...
    aria-label={label}
    className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-gray-900 hover:text-white transition-all duration-300 hover:scale-110"
  >
    {children}
  </a>
);
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-900 transition-colors"
                />
                <button
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-3">
              <SocialIcon href="https://twitter.com/Don_ugob" label="Twitter">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <SocialIcon href="https://github.com/donugob" label="GitHub">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
        ...
        <div className="border-t border-gray-200 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} Build With Ugo.B. All rights
              reserved.
            </p>
