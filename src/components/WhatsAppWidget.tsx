...
const WhatsAppWidget = () => {
  ...
  const phoneNumber = "2348103579586";
  const message = encodeURIComponent("Hello! I'm interested in starting a project with Build With Ugo.B.");
          ...
          <AnimatePresence>
            {isHovered && (
              <motion.div
                ...
                className="overflow-hidden whitespace-nowrap pr-6"
              >
