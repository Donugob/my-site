...
const ServicesPage = () => {
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'We create a detailed roadmap, wireframes, and technical specifications tailored to your needs.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Our team brings your vision to life with modern designs and clean, scalable code.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: '30 days of post-launch support, plus ongoing maintenance and optimization as you scale.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const faqs = [
    {
      ...
      answer: 'Most projects take 6-12 weeks from kickoff to launch, depending on complexity. We provide a detailed timeline during our initial consultation and keep you updated throughout the process.'
    },
    {
      question: 'What technologies do you use?',
      answer: 'We specialize in modern tech stacks including React, Next.js, Node.js, TypeScript, and Tailwind CSS. We choose the best tools based on your specific project requirements.'
    },
    {
      question: 'Do you offer website maintenance?',
      answer: 'Yes! All projects include 30 days of post-launch support. We also offer ongoing maintenance packages for updates, security patches, and feature additions.'
    },
    {
      question: 'Can you work with my existing website?',
      answer: 'Absolutely! We can audit, optimize, redesign, or add new features to existing websites. We work with most modern platforms and frameworks.'
    },
    {
      question: 'What\'s your pricing structure?',
      answer: 'Pricing varies based on project scope, complexity, and timeline. We offer fixed-price packages for standard projects and custom quotes for unique requirements. Contact us for a detailed proposal.'
    },
    {
      question: 'Do you provide hosting services?',
      answer: 'We can help you choose and set up the best hosting solution for your needs (Vercel, Netlify, AWS, etc.), and we provide guidance on deployment and maintenance.'
    }
  ];
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              From concept to launch and beyond, we provide full-stack web development services 
              that help businesses establish a powerful online presence and achieve measurable growth.
            </p>
          </div>
          ...
          >
            <div className="bg-white rounded-2xl p-6 border border-gray-200 text-center">
              <div className="text-3xl font-bold text-gray-900 mb-2">6-12 Weeks</div>
              <div className="text-sm text-gray-600">Average Delivery Time</div>
            </div>
            <div className="bg-white rounded-2xl p-6 border border-gray-200 text-center">
              <div className="text-3xl font-bold text-gray-900 mb-2">25+ Projects</div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A proven process that ensures quality results and transparent communication every step of the way
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {[
                ...
                >
                  <div className={`text-base font-semibold text-gray-900 group-hover:text-${tech.color}-600 transition-colors`}>
                    {tech.name}
                  </div>
                </div>
              ))}
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                  quote: "The team delivered our e-commerce platform ahead of schedule. Sales increased by 200% in the first three months. Highly recommend!",
                  author: "Richard Emeka",
                  role: "Owner, Richie's Pot",
                  avatar: "https://i.pravatar.cc/150?img=5"
                },
                {
                  quote: "Professional, responsive, and technically excellent. They transformed our outdated site into a modern, high-performing platform.",
                  author: "Damilare",
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">
              Let's discuss your goals and create a custom solution that drives real results for your business.
            </p>
